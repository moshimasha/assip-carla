...
class FollowLeadingVehicleCustom(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(FollowLeadingVehicleCustom, self).__init__("FollowVehicle",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
    ...
    def _setup_scenario_trigger(self, config):
        ...
        """
        #TODO: find original time of day of the scenario
        #check_dtime = operator.attrgetter("Datetime")
        dtime = datetime.datetime.now()+timedelta(minutes=1) 
        return conditions.TimeOfDayComparison(dtime)
    ...
    def _create_behavior(self):
        ...
        """
#vehicleturningright
#vehiclerunningredlight
#followleadingvehicle
        # to avoid the other actor blocking traffic, it was spawed elsewhere
        # reset its pose to the required one
    #    location = self.ego_vehicles[0].get_location()
    #    location.z+=4
    #    self.other_actors[0].set_location(location)
